...
type AuthClient interface {
	...
	Register(ctx context.Context, in *BasicCredentials, opts ...grpc.CallOption) (*Token, error)
}
...
func (c *authClient) Register(ctx context.Context, in *BasicCredentials, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
...
type AuthServer interface {
	...
	Register(context.Context, *BasicCredentials) (*Token, error)
}
...
func (UnimplementedAuthServer) Register(context.Context, *BasicCredentials) (*Token, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*BasicCredentials))
	}
	return interceptor(ctx, in, info, handler)
}
